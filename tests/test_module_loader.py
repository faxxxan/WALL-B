...
class TestModuleLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_listdir = self.patcher_os_listdir.start()
    ...
    def test_load_yaml_files_enabled_and_env_string(self):
        ...
        self.mock_listdir.return_value = ['mod1.yml']
        mock_file = MagicMock()
        ...
        from module_loader import ModuleLoader
        loader = ModuleLoader(config_folder='config', environment='robot')
    ...
    def test_load_yaml_files_env_list(self):
        ...
        modules = loader.load_yaml_files()
        self.assertEqual(len(modules), 1)
        loader = ModuleLoader(config_folder='config', environment='other')
        modules = loader.load_yaml_files()
        self.assertEqual(len(modules), 0)
