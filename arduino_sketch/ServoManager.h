...
namespace ModularBiped
{
    ...
    public:
        ...
        void doInit()
        {
            ...
            this->ServoLLHP.attach(Config::PIN_SLLHP, Config::StartingPos[8]);
            this->ServoRLHP.attach(Config::PIN_SRLHP, Config::StartingPos[9]);
            ...
            {
                // stationarySteps(); // Move to standing pose
...
// iterate over PosRest and output values:
        ...
        {
            int left[Config::SERVO_COUNT] = {Config::PosStart[0], Config::PosStart[1], Config::PosStart[2], Config::PosStand[3], Config::PosStand[4], Config::PosStand[5], Config::NOVAL, Config::NOVAL, Config::PosMax[8], Config::PosMax[9]};
            int right[Config::SERVO_COUNT] = {Config::PosStand[0], Config::PosStand[1], Config::PosStand[2], Config::PosStart[3], Config::PosStart[4], Config::PosStart[5], Config::NOVAL, Config::NOVAL, Config::PosMax[8], Config::PosMax[9]};
